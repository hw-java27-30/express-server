...
import {Book, BookDto, Reader, ReaderDto} from "../model/Book.js";
import {convertBookDtoToBook, convertReaderDtoToReader, getGenre, getStatus} from "../utils/tools.js";
...
export const pickUpBook = async (req: Request, res: Response) => {
    ...
    console.log(reader);
    const reader_id: Reader = convertReaderDtoToReader(reader as string)
    await service.pickUpBook(id as string, reader_id);
